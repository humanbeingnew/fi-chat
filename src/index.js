...
<script>
let ws=null, me="", room="", token="", adminToken="", reconnectTimer=null, manuallyLeft=false, connecting=false;
...
function connect(){
  ...
  // 관리자 비밀번호는 절대로 WebSocket URL에 넣지 않습니다.
