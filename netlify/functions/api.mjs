...
async function freshRoom(room,data){return !!(data&&data.roomName&&canonicalRoom(data.roomName)===canonicalRoom(room)&&Number.isFinite(Number(data.createdAt))&&Number(data.createdAt)+ROOM_RESET_MS>Date.now()&&data.password&&data.generation)}
